...
if (isset($_GET["source"]))
{
   ...
   if ((preg_match(D_WEB_PATH . "#^[a-z0-9]*[.]php$#i", $source) ||
       // eregi("^" . D_WEB_PATH . "templates/[a-z0-9]*[.]tpl$", $source) ||
       // mb_ereg_match("^" . D_WEB_PATH . "templates/[a-z0-9]*[.]tpl$", $source) ||
       preg_match("/^/" . D_WEB_PATH . "/templates\/[a-z0-9]*[.]tpl$/i", $source) ||
       ...
       // mb_ereg_match("^" . D_WEB_PATH . "customer/[a-z0-9]*[.]php$", $source) ||
       preg_match("/^/" . D_WEB_PATH . "/customer\/[a-z0-9]*[.]php$/i", $source) ||

       // eregi("^" . D_WEB_PATH . "auth/[a-z0-9]*[.]php$", $source) ||
       // mb_ereg_match("^" . D_WEB_PATH . "auth/[a-z0-9]*[.]php$", $source) ||
       preg_match("/^/" . D_WEB_PATH . "/auth\/[a-z0-9]*[.]php$/i", $source) ||

       // eregi("^" . D_WEB_PATH . "order/[a-z0-9-]*[.]php$", $source) ||
       // mb_ereg_match("^" . D_WEB_PATH . "order/[a-z0-9-]*[.]php$", $source) ||
       preg_match("/^/" . D_WEB_PATH . "/order\/[a-z0-9-]*[.]php$/i", $source) ||

       // eregi("^" . D_WEB_PATH . "search/[a-z0-9]*[.]php$", $source) ||
       // mb_ereg_match("^" . D_WEB_PATH . "search/[a-z0-9]*[.]php$", $source) ||
       preg_match("/^/" . D_WEB_PATH . "/search\/[a-z0-9]*[.]php$/i", $source) ||

       // eregi("^" . D_WEB_PATH . "cart/[a-z0-9]*[.]php$", $source)) &&
       // mb_ereg_match("^" . D_WEB_PATH . "cart/[a-z0-9]*[.]php$", $source)) &&
       preg_match("/^/" . D_WEB_PATH . "/cart\/[a-z0-9]*[.]php$/i", $source)) &&
